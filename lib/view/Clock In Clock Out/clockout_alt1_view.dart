...
class ClockOutAlt1 extends StatefulWidget {
  @override
  _ClockOutAlt1State createState() => _ClockOutAlt1State();
}

class _ClockOutAlt1State extends State<ClockOutAlt1> {
              ...
              children: [
                Column(
                  children: [
                    ...
                    Text(
                      DateFormat.Hm().format(DateTime(2022, 3, 10, 7, 50)),
                      style: TextStyle(
                        fontFamily: "Roboto",
                        fontSize: 20,
                        fontWeight: FontWeight.w700,
